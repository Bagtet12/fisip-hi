...
<header id="header" data-transparent="true" class="dark">
    <div class="header-inner">
        <div class="container">
            <!--Logo-->
            <div id="logo" data-bg-image="homepages/creative/images/slider/Logo Web HI.jpg"><a href="{{route('home')}}"></a></div>
            <!--End: Logo-->
            <!-- Search -->
                ...
                <div class="container">
                    <nav>
                        <ul>
                            ...
                            <li class="dropdown"><a href="#">Administrator</a>
                                <ul class="dropdown-menu">
                                    <li class="dropdown-submenu"><a href="#">Visits</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="{{ route('visit.create') }}">Create</a>
                                            </li>
                                            <li><a href="#">List of Data</a>
                                            </li>
                                        </ul>
                                    </li>
            ...
            <section class="background-grey" id="section5"> 
                <div class="container">
                    ...
                    <div class="row team-members">
                        ...
                        <div class="col-lg-16">
                            <a href="#" class="btn btn-primary btn-sm btn-rounded mb-2">Create Visits Data</a>
                        </div>
                    </div>
                </div>
            </section>
