                    ...
                    <div class="slide kenburns" data-bg-image="homepages/creative/images/slider/1.png">
                        ...
                        <div class="container">
                            <div class="slide-captions text-center">
                                <!-- Captions -->
                                <h1 class="m-b-20 text-light text-uppercase">Profile</h1>
                                <!-- end: Captions -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="slide slide-dark kenburns" data-bg-image="homepages/creative/images/slider/2.png">
                        ...
                        <div class="container">
                            <div class="slide-captions text-dark text-center">
                                <!-- Captions -->
                                <h1 class="m-b-20 text-uppercase">Profile</h1>
                                <!-- end: Captions -->
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4" data-animate="fadeInUp" data-animate-delay="600"><h3>Mission</h3><hr>
                            <br><p>Developing an academic culture in the organization of education and teaching that is participatory, critical, innovative, and constructive.
                            </p>
                            <br> 
                            <span>
...
@section('content2')
             <!-- PROCESS -->
             <section class="easy-fast" style="background-color: white">
                <div class="container">
                    <div class="row">
                        <h1 style="text-align: center" class="text-lg text-uppercase">Introduction<hr style="color: black"></h1>
...
@section('content3')
            ...
            <section id="easy-fast" class="text-light p-b-40" style="background-color:#973735;">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center" data-animate="fadeInUp" data-animate-delay="300"><h1 class="text-center bold">History</h1><hr>
                            <br><h3 style="text-align: justify">The Undergraduate Study Program in International Relations at Jember University was established based on the Decree of the Minister of Higher Education and Science of the Republic of Indonesia Number 151 of 1964 concerning the establishment of a Public University in Jember dated 10 November 1964. The decree was signed by Minister dr. Sjarif Thajeb.</h3></div>
